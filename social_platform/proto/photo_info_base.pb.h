...
inline ::google::protobuf::int32 PhotoInfoBase::ver() const {
  return ver_;
}
inline void PhotoInfoBase::set_ver(::google::protobuf::int32 value) {
  set_has_ver();
  ver_ = value;
}
...
inline ::google::protobuf::int32 PhotoInfoBase::user_id() const {
  return user_id_;
}
inline void PhotoInfoBase::set_user_id(::google::protobuf::int32 value) {
  set_has_user_id();
  user_id_ = value;
}
...
inline ::google::protobuf::int32 PhotoInfoBase::last_publisher() const {
  return last_publisher_;
}
inline void PhotoInfoBase::set_last_publisher(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 PhotoInfoBase::last_publish_time() const {
  return last_publish_time_;
}
inline void PhotoInfoBase::set_last_publish_time(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 PhotoInfoBase::last_publish_message_id() const {
  return last_publish_message_id_;
}
inline void PhotoInfoBase::set_last_publish_message_id(::google::protobuf::int32 value) {
