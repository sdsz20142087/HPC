...
inline ::google::protobuf::int32 MessageInfoBase::ver() const {
  return ver_;
}
inline void MessageInfoBase::set_ver(::google::protobuf::int32 value) {
  set_has_ver();
  ver_ = value;
}
...
inline void MessageInfoBase::set_has_user_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MessageInfoBase::clear_has_user_id() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::int32 MessageInfoBase::user_id() const {
  return user_id_;
}
inline void MessageInfoBase::set_user_id(::google::protobuf::int32 value) {
  set_has_user_id();
  user_id_ = value;
}
...
inline ::google::protobuf::int32 MessageInfoBase::message_id() const {
  return message_id_;
}
inline void MessageInfoBase::set_message_id(::google::protobuf::int32 value) {
  set_has_message_id();
  message_id_ = value;
}
...
inline ::google::protobuf::int32 MessageInfoBase::publish_time() const {
  return publish_time_;
}
inline void MessageInfoBase::set_publish_time(::google::protobuf::int32 value) {
